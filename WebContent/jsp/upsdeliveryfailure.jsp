				...
				<div id="menublank">
					<div id="menu">
						<ul>
							...
							<li style="margin-right: 330px;"><a href="/projectGDMS/jsp/contactus.jsp" class="menu">Contact
									Us</a></li>
...
<form action="updatecontrol" method="post" name="deliveryfailure"  >
<h1 style="color: white;" align="center">Booking ID does not exist</h1>
