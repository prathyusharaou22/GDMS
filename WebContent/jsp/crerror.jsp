...
<div id="headerbg">
  <div id="headerblank">
	...
	<div id="menublank">
	  ...
	  <br>
	  <br>
	  <h3 align="center" style="padding-top: 150px"><font color="white">Customer does not exist,please Register</font></h3>
	  <div style="margin-left: 500px;margin-top: 30px;">
	  <input type="button" value="try again" onclick="window.location='/projectGDMS/jsp/Login.jsp';">
	  </div>
</div>
</div>
</div>
